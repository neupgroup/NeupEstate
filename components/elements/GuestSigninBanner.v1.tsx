...
export function GuestSigninBannerV1({ variant }: GuestSigninBannerProps) {
  ...
  return (
    <section className={cn("container mx-auto px-4 sm:px-6 lg:px-8", isHero ? "py-6" : "py-4")}>
      <div
        className={cn(
      ...
      >
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-sm font-semibold text-foreground">Sign in for personalized recommendations and support.</h2>
