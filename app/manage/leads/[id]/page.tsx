...
import { getConversationByAccountId, getConversationById } from '@/services/conversation-service';
...
export default async function LeadProfilePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (!account) {
        // Create a temporary account-like structure for display if one doesn't exist.
        // This can happen for leads that originated before the account system was in place.
        account = {
